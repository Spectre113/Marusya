...
Проект демонстрирует практику разработки production-like SPA:

- роутинг и protected routes
- работа с асинхронным серверным состоянием
- типобезопасная интеграция с API
- валидация данных на уровне контрактов
- модульная архитектура компонентов и хуков
- базовые инженерные quality gates (lint/build)
